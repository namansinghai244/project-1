...
function displaySelectedSol(sols) {
  ...
  // 👉 CURRENT DATE = TODAY (EARTH)
  currentDateElement.innerText = formatDate(new Date())
...
function displayPreviousSols(sols) {
  ...
  sols.forEach((solData, index) => {
    ...
    solContainer.querySelector('[data-date]').innerText =
      formatDate(solData.date)
...
function updateUnits() {
  document
    .querySelectorAll('[data-speed-unit]')
    .forEach(unit => {
